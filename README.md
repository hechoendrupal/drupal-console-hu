# drupal-console-hu
DrupalConsole Hungarian Language / Magyar nyelven
...
To install Drupal Console package for Catalan language run the following instructions

```
$ composer require drupal/console-hu
```
...
- Fork this repository following this link [https://github.com/hechoendrupal/drupal-console-hu#fork-destination-box](https://github.com/hechoendrupal/drupal-console-hu#fork-destination-box)
...
```
$ git remote add upstream git@github.com:hechoendrupal/drupal-console-hu.git
```
